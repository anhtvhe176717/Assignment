...
<html>
    ...
    <body >
            ...
            <div class="container" >
                ...
                <div class="info">
                    ...
                    <center>
                        ...
                        <form id="myForm" action="department" method="post">
                            <div class="container">
                                <c:set var="de" value="${requestScope.depart}"/>

                                <select id="mySelect" class="form-select" name="department">
                                    <option>Department</option>
                                    <c:forEach items="${requestScope.listd}" var="d">
                                        <option value="${d.codedepart}" ${d.codedepart == de.codedepart ?'selected':''}>${d.departname}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </form><br/><br/><br/>

                        <form action="searchdepart" method="post">
                            <tr>
                            <div class="search-bar">
                                <input type="text" class="search-input" name="search" placeholder="Search Personnel(Code,Name)" value="${param.search}"/>
                                <c:choose>
                                    <c:when test="${requestScope.depart == null}">
                                        <input type="hidden" name="code" value=""/>

                                    </c:when>
                                    <c:otherwise>
                                        <input type="hidden" name="code" value="${de.codedepart}"/>
                                    </c:otherwise>
                                </c:choose>
        ...
        <script>
            // Lấy tham chiếu đến phần tử select và form
            const selectElement = document.getElementById('mySelect');
            const formElement = document.getElementById('myForm');

            // Thêm sự kiện "change" cho select
            selectElement.addEventListener('change', function () {
                // Tự động gửi form khi sự kiện "change" xảy ra
                formElement.submit();
            });
        </script>
    </body>
